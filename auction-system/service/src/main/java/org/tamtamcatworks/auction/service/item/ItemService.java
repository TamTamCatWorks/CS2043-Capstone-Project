...
public class ItemService {
  ...
  public Item create(
    ...
    Item item =
        creator.create(
            name, description, startingPrice, parseCondition(condition), imageUrl, seller, details);

    return itemRepository.save(java.util.Objects.requireNonNull(item, "Item must not be null"));
  }
