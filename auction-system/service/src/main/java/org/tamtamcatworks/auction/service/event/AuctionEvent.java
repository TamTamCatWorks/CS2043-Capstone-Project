 ...
 * org.tamtamcatworks.auction.service.auction.AuctionService} whenever an auction's status changes
 * (OPENED, CLOSED, CANCELLED).
 *
 * <p>Consumed by:
 *
 * <ul>
 *   <li>Teammate A — {@code NotificationService} to persist Notification rows.
 *   <li>Teammate B — {@code NotificationBroadcastListener} to push via WebSocket.
 * </ul>
 */
