...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
  ...
  /**
   * Registers {@link WebSocketSessionRegistry} as a decorator factory so it can intercept raw
   * WebSocket connection lifecycle events and maintain the userId → session map used by {@link
   * SuspendedUserWsHandler}.
   */
  @Override
