...
public class WebSecurityConfig {
  ...
  public SecurityFilterChain filterChain(
      HttpSecurity http, UserRepository userRepository, ObjectMapper objectMapper)
      throws Exception {
    ...
    SuspendedUserFilter suspendedUserFilter = new SuspendedUserFilter(userRepository, objectMapper);

    http.addFilterAfter(suspendedUserFilter, SecurityContextHolderFilter.class)
        .csrf(
            csrf ->
        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers("/ws/**")
                    ...
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/auctions", "/auctions/*", "/auctions/*/bids")
                    .permitAll()
