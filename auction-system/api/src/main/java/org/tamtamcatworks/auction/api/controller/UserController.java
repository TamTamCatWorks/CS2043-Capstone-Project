...
public class UserController {
  ...
  public ResponseEntity<UserResponse> register(@RequestBody RegisterRequest req) {
    return ResponseEntity.status(HttpStatus.CREATED).body(userService.registerByRequest(req));
  }
  ...
  @PostMapping("/top-up")
  public ResponseEntity<UserResponse> topUp(@RequestBody TopUpRequest req, HttpSession session) {
