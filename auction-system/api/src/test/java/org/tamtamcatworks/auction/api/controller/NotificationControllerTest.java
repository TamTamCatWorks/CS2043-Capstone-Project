...
class NotificationControllerTest {
    ...
    void testGetMyNotifications() throws Exception {
        ...
        NotificationResponse resp = new NotificationResponse("notif123", "OUTBID", "You have been outbid.", false, "2026-06-02T12:00:00");
    ...
    void testMarkOneRead() throws Exception {
        mockMvc.perform(patch("/notifications/notif123/read"))
                .andExpect(status().isNoContent());
