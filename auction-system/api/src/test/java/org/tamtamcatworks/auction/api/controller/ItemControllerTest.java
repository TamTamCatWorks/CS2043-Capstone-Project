...
class ItemControllerTest {
    ...
    void testCreateItem() throws Exception {
        ...
        ItemRequest request = new ItemRequest("ART", "Starry Paint", "Rep paint", 200.0, "GOOD", null, "img", Map.of());
        ItemResponse response = new ItemResponse("item123", "Starry Paint", "Rep paint", 200.0, "GOOD", "seller123", "Starry", "img");
    ...
    void testGetItem() throws Exception {
        ...
        mockMvc.perform(get("/items/item123"))
