...
public class User extends BaseEntity {
   ...
   * Tạo user mới.
   *
   * <p>LOGIC CONSTRUCTOR: 1. Gọi super() → sinh UUID cho entityId, ghi createdAt 2. Gán thông tin
   * cơ bản (username, email, passwordHash, fullName) 3. Khởi tạo balance với số tiền ban đầu 4. Tạo
   * BuyerProfile và SellerProfile rỗng cho user
   *
   * <p>NOTE: - passwordHash phải được hash trước khi truyền vào (không lưu plain text) -
   ...
   */
  public User(
      String username, String email, String passwordHash, String fullName, double initialBalance) {
   ...
   *
   * <p>IMPLEMENT POLYMORPHISM: - Entity yêu cầu subclass implement getDisplayInfo() - User cung cấp
   * format riêng cho user
   *
   * <p>FORMAT: - Username, ID, Balance
   *
