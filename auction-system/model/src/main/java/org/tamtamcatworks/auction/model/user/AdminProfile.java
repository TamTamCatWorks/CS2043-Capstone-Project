 ...
 *
 * <p>KHÔNG kế thừa Entity — dùng userId làm PK/FK.
 *
 * <p>Lưu danh sách quyền hạn (permissions) và log hành động quản trị. Admin KHÔNG tham gia đấu giá
 * — không có BidderRole hay SellerRole.
 *
 * <p>Permission lưu dạng List<String> thay vì EnumSet để dễ serialize xuống DB và linh hoạt thêm
 * permission mới không cần đổi schema. Các giá trị hợp lệ: MANAGE_USERS, MANAGE_ITEMS,
