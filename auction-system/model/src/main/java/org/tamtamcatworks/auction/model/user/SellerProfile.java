 ...
 *
 * <p>KHÔNG kế thừa Entity — dùng chung userId làm PK với bảng users.
 *
 * <p>Lưu lịch sử bán hàng và đánh giá uy tín lâu dài của người bán. Khác SellerRole (RAM, tạm thời
 * trong 1 phiên) — SellerProfile tồn tại vĩnh viễn và tích lũy qua nhiều phiên.
 */
@Entity
public class SellerProfile extends BaseEntity {
  ...
  @ElementCollection private List<String> listings = new ArrayList<>();
