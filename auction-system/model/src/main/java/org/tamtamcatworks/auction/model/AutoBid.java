 ...
 *
 * <p>Khi có bid mới, {@code AutoBidService} sẽ dùng PriorityQueue để tìm auto-bidder tốt nhất
 * (maxBid cao nhất) và tự động đặt giá thay họ, cho đến khi không còn auto-bidder nào có thể cạnh
 * tranh.
 */
@Entity
@Table(
