...
public class AdminSidebar extends VBox {
  ...
  public AdminSidebar() {
    ...
    getStyleClass().add("admin-sidebar");

    Button logsButton = new Button("Audit Logs");
    ...
    dashboardButton.setOnAction(
        event -> Navigation.navigateTo("/fxml/admin/dashboard/admin-dashboard.fxml"));

    usersButton.setOnAction(event -> Navigation.navigateTo("/fxml/admin/users/users-list.fxml"));

    auctionsButton.setOnAction(
        event -> Navigation.navigateTo("/fxml/admin/auctions/auctions-list.fxml"));

    notificationsButton.setOnAction(
        event -> Navigation.navigateTo("/fxml/admin/notification/admin-notifications.fxml"));

    logsButton.setOnAction(event -> Navigation.navigateTo("/fxml/admin/logs/audit-logs.fxml"));
    ...
    getChildren()
        .addAll(dashboardButton, usersButton, auctionsButton, notificationsButton, logsButton);
  }
}
