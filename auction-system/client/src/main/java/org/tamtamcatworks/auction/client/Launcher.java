...
public class Launcher extends Application {
  ...
  static final String APP_ICON_PATH =
      Objects.requireNonNull(Launcher.class.getResource(ASSETS_DIR + "icons/app-icon.png"))
          .toExternalForm();
  ...
  public void start(Stage stage) throws IOException {
    ...
    Navigation.registerAll(
        ...
        org.tamtamcatworks.auction.client.controller.admin.auctions.AuctionsManagementController
            .class,
        org.tamtamcatworks.auction.client.controller.admin.notification.AdminNotificationsController
            .class,
  ...
  private void loadApplicationProperties() {
    try {
      ...
      properties.forEach(
          (key, value) -> System.setProperty(String.valueOf(key), String.valueOf(value)));
    } catch (IOException e) {
